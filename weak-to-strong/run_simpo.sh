...
# weak model ceiling
python train_simpo.py --model_size ${weak_model_size} \
                    --ds_name ${ds} \
                    --results_folder results_${ds} \
                    --minibatch_size_per_device=1 --lr=1e-6 \
...
python train_simpo.py --model_size ${strong_model_size} \
                    --ds_name ${ds} \
                    --results_folder results_${ds} \
                    --minibatch_size_per_device=1 --lr=1e-6 \
                    --n_docs=4000 --n_w2s_docs=4000 --n_test_docs=4000 \
...
# weak-to-strong explict conflict
python train_simpo.py --model_size ${strong_model_size} \
                       --weak_model_size ${weak_model_size} \
                       --ds_name ${ds} \
                       --results_folder results_${ds} \
...
python train_simpo.py --model_size ${strong_model_size} \
                    ...
                    --sft_epochs=1 \
                    --epochs=1 \
                    --high_conf_filter --conf_threshold=0.75 \
                    --max_ctx=512
